...
/**
 * Archivo: app/Support/Media/MediaArtifactCollector.php
...
namespace App\Support\Media; // Ej.: "App\Support\Media"

use App\Support\Media\Contracts\MediaOwner; // Interfaz que expone getMedia() // Ej.: $owner->getMedia('avatar') => Collection<Media>
