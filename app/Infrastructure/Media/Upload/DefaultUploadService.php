...
use App\Application\Media\DTO\QueuedUploadResult;
...
use App\Infrastructure\Media\Upload\Scanning\ScanCoordinator;
use App\Infrastructure\Media\Jobs\ProcessUploadJob;
use App\Infrastructure\Media\Security\Upload\UploadSecurityLogger;
use App\Infrastructure\Media\Upload\Support\ImageUploadReporter;
...
final class DefaultUploadService implements UploadService, MediaUploader
{
     ...
     * @param ScanCoordinator $scanCoordinator Coordinador de escaneo antivirus
    ...
    public function __construct(
        ...
        private readonly ScanCoordinator $scanCoordinator,
