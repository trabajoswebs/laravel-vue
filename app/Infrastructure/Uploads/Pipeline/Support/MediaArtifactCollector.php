...
use App\Application\Uploads\Media\Contracts\MediaArtifactCollector as MediaArtifactCollectorContract;
use App\Application\Uploads\Media\Contracts\MediaOwner; // Interfaz que expone getMedia() // Ej.: $owner->getMedia('avatar') => Collection<Media>
